...
This package contains the following precompiled binaries for macOS:
 ...
 - `Prompt Security Redirector.app`: The app bundle that sets up and hosts the network extension for redirecting traffic.
...
- Clicking "Build" in XCode should automatically install `/Applications/Prompt Security Redirector.app`.
